...
CREATE TABLE `Content` (
  ...
  CONSTRAINT `content_ibfk_2` FOREIGN KEY (`InstructorID`) REFERENCES `instructor` (`InstructorID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `Content` VALUES ('content_name',1,'it is a demo',1,1);
